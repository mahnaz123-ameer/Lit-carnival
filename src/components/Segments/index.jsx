    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
        ...
        <div className="relative container mx-auto px-6 py-16">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              <Theater className="w-8 h-8 text-yellow-300" />
              <div>
                <h1 className="text-4xl font-bold">Competition Segments</h1>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-amber-900 mb-4">Event Segments Overview</h2>
        ...
        <div className="space-y-12">
          {segments.map((segment, index) => (
            <div key={segment.id} className={`bg-gradient-to-r ${segment.bgColor} rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1`}>
              <div className="flex flex-col lg:flex-row items-start space-y-6 lg:space-y-0 lg:space-x-8">
                {/* Icon and Title */}
                <div className="flex-shrink-0">
                  <div className={`w-20 h-20 bg-gradient-to-br ${segment.color} text-white rounded-2xl flex items-center justify-center shadow-lg`}>
                    {segment.icon}
                  </div>
                </div>
                ...
                <div className="flex-grow">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
                    <div>
                      <h2 className="text-3xl font-bold text-amber-900 mb-2">{segment.title}</h2>
                  ...
                  <div>
                    ...
                    <div className="grid gap-3">
                      {segment.themes.map((theme, themeIndex) => (
                        <div key={themeIndex} className="bg-amber-50 bg-opacity-90 p-4 rounded-lg shadow-sm border border-amber-200 hover:shadow-md hover:bg-amber-100 transition-all">
                          <p className="text-amber-900 font-medium">{theme}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {segment.id === 'cosplay' && (
                    <div className="mt-6 p-4 bg-amber-100 bg-opacity-80 rounded-lg border border-amber-200">
                      <h4 className="font-semibold text-amber-900 mb-2">Competition Categories:</h4>
                  ...
                  {segment.id === 'poster' && (
                    <div className="mt-6 p-4 bg-amber-100 bg-opacity-80 rounded-lg border border-amber-200">
                      <h4 className="font-semibold text-amber-900 mb-2">Presentation Format:</h4>
        ...
        {/* Important Notes */}
        <div className="mt-16 bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 shadow-xl border-2 border-amber-200">
          <h2 className="text-2xl font-bold text-amber-900 mb-6 text-center">Important Guidelines</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-amber-900 mb-3">General Rules:</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-amber-900 mb-3">Registration:</h3>
              <ul className="space-y-2 text-amber-800">
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-red-700 via-red-600 to-amber-600 text-white p-8 rounded-2xl shadow-xl border-2 border-red-800">
            <h2 className="text-2xl font-bold mb-4">Ready to Participate?</h2>
            <p className="text-lg mb-6">Choose your segment and register now to secure your spot!</p>
            <button className="bg-amber-100 text-red-800 px-8 py-3 rounded-lg font-semibold hover:bg-amber-200 transition-colors shadow-lg border-2 border-amber-300">
              Register Now
            </button>
          </div>
        </div>
